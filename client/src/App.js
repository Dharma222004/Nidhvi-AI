              ...
              switch (event) {
                ...
                case "analysis":
                  acc = {
                    ...
                    hospitalSearchParams: data.hospitalSearchParams,
                  };
                  setResults({ ...acc });
                  break;
                case "explanation_chunk":
                  if (mode === "clinician") {
                    acc.explanation = {
                      ...acc.explanation,
                      clinicalSummary:
                        (acc.explanation.clinicalSummary || "") + data.chunk,
                    };
                  } else {
                    acc.explanation = {
                      ...acc.explanation,
                      explanation:
                        (acc.explanation.explanation || "") + data.chunk,
                    };
                  }
                  setResults({ ...acc });
                  break;
        ...
        <AnimatePresence mode="wait">
          {!results ? (
              ...
              <motion.div variants={fadeInUp} className="pt-12">
                <div className="text-center mb-10">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
                    Try with{" "}
                    <span className="gradient-text">Sample Reports</span>
                  </h2>
            ...
            >
              ...
              >
                <QAChat analysisContext={results} language={selectedLanguage} />
              </motion.div>
            </motion.div>
          )}
        </AnimatePresence>
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-purple-300/50 text-sm max-w-md mx-auto">
              Empowering healthcare understanding through intelligent AI
              analysis
            </p>
          </div>
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-purple-500/30 text-xs">
              © 2026 Nidhvi AI. Built with 💜 for better healthcare
              understanding.
            </p>
          </div>
        </motion.div>
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-purple-200/50 text-sm truncate mb-3">
            {description}
          </p>
          <span
